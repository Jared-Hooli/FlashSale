...
public class CodeMsg {
	...
	// 秒杀模块 5005xx
	public static final CodeMsg FLASHSALE_OVER = new CodeMsg(500500, "商品已经秒杀完毕");
	public static final CodeMsg REPEATE_FLASHSALE = new CodeMsg(500501, "不能重复秒杀");
	public static final CodeMsg FLASHSALE_FAIL = new CodeMsg(500502, "秒杀失败");
